    ...
    function defDay(ds) {
      ...
      return { worked: dow >= 1 && dow <= 5, isHoliday: false, satAbsent: false, sunAbsent: false, leave: false, leaveHours: 0, leaveStart: '', leaveEnd: '', absentHours: 0, workIn: '', workOut: '', ot: { "1": 0, "1.5": 0, "2": 0, "3": 0 }, lateMin: 0, note: '' };
    }
